...
to go
  ...
  ask one-of pd-s  [
    hatch-pd-s 1 [
      ...
      let degrees-of-mutation precision (random-normal 1 4 ) 0     ;;-> how much mutation does actualy happen in real- life?
      if degrees-of-mutation < 0 [set degrees-of-mutation degrees-of-mutation * (-1)]
